...
//                }
    ...
    public void logOut(String phnNum, String code) {
        verifyClient.command(code, phnNum, Command.LOGOUT, new CommandListener() {
            @Override
            public void onSuccess(Command command) {
                // successfully logged out user
                // Yay.
            }
            //I'm sure these guys have their uses, but I'm not gonna bother right now.
            @Override
